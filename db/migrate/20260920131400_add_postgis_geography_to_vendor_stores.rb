class AddPostgisGeographyToVendorStores < ActiveRecord::Migration[7.2]
  def up
  ...
  def down
    remove_index :spree_vendor_stores, :location if index_exists?(:spree_vendor_stores, :location)
